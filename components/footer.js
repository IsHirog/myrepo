class CustomFooter extends HTMLElement {
  connectedCallback() {
    ...
    featherScript.onload = () => feather.replace({ 'root': this.shadowRoot });
    this.shadowRoot.appendChild(featherScript);

    // 1️⃣ Contagem de visitantes via CounterAPI
    ...
    // 2️⃣ Último repositório atualizado no GitHub
    fetch("https://api.github.com/users/IsHirog/repos?sort=updated&direction=desc")
      ...
      .catch(() => {
        this.shadowRoot.querySelector("#repo-link").textContent = "Erro";
      });
